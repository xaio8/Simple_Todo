        ...
        <form onSubmit={handleSubmit} className="p-4 space-y-4">
          <div>
            ...
            <input
              ...
              className="w-full px-3 py-2 text-gray-500 dark:text-gray-300 bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500"
              required
            />
          </div>
          <div>
          ...
          <div className="flex gap-3 pt-2">
            ...
            <button
              type="submit"
              className="flex-1 px-4 py-2 text-sm font-medium text-white bg-blue-600 rounded-lg hover:bg-blue-700 dark:hover:bg-blue-500"
            >
              Save Changes
            </button>
          </div>
