      ...
      <div className="w-full max-w-lg bg-gray-100 dark:bg-gray-800 rounded-2xl shadow-md p-4 sm:p-6 border-none">
        ...
        <div className="mb-4">
          ...
          <input
            ...
            className="w-full px-4 py-2 text-gray-700 rounded-lg border border-gray-300 bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:bg-white transition-colors"
          />
        </div>
        ...
        <div className="mb-5">
          ...
          <textarea
            ...
            rows={4}
            className="w-full px-4 py-2 rounded-lg border border-gray-300 bg-gray-50 text-gray-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:bg-white transition-colors"
          />
        </div>
